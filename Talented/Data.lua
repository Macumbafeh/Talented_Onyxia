...
--    DEATHKNIGHT = "",
  ...
  spelldata.Bat[1][2] = deep_copy(FamilySkills[2])
  spelldata.Bat[1][12] = deep_copy(FamilySkills[12])
  spelldata.Bat[1][13] = deep_copy(FamilySkills[13])
  spelldata.Bear[1][2] = deep_copy(FamilySkills[2])
  spelldata.Bear[1][3] = deep_copy(FamilySkills[3])
  spelldata.Boar[1][2] = deep_copy(FamilySkills[2])
  spelldata.Boar[1][6] = deep_copy(FamilySkills[6])
  spelldata.Boar[1][14] = deep_copy(FamilySkills[14])
  spelldata.Cat[1][2] = deep_copy(FamilySkills[2])
  spelldata.Cat[1][3] = deep_copy(FamilySkills[3])
  spelldata.Cat[1][6] = deep_copy(FamilySkills[6])
  spelldata.Cat[1][15] = deep_copy(FamilySkills[15])
  spelldata.Crab[1][3] = deep_copy(FamilySkills[3])
  spelldata.Crocolisk[1][2] = deep_copy(FamilySkills[2])
  spelldata.Gorilla[1][2] = deep_copy(FamilySkills[2])
  spelldata.Gorilla[1][16] = deep_copy(FamilySkills[16])
  spelldata.Hyena[1][2] = deep_copy(FamilySkills[2])
  spelldata.Hyena[1][6] = deep_copy(FamilySkills[6])
  spelldata.Raptor[1][2] = deep_copy(FamilySkills[2])
  spelldata.Raptor[1][3] = deep_copy(FamilySkills[3])
  spelldata.Scorpid[1][3] = deep_copy(FamilySkills[3])
  spelldata.Scorpid[1][17] = deep_copy(FamilySkills[17])
  spelldata.Spider[1][2] = deep_copy(FamilySkills[2])
  spelldata.Tallstrider[1][2] = deep_copy(FamilySkills[2])
  spelldata.Tallstrider[1][6] = deep_copy(FamilySkills[6])
  spelldata.Turtle[1][2] = deep_copy(FamilySkills[2])
  spelldata.Turtle[1][18] = deep_copy(FamilySkills[18])
  spelldata.Wolf[1][2] = deep_copy(FamilySkills[2])
  spelldata.Wolf[1][6] = deep_copy(FamilySkills[6])
  spelldata.Wolf[1][20] = deep_copy(FamilySkills[20])
  spelldata["Bird of Prey"][1][3] = deep_copy(FamilySkills[3])
  spelldata["Bird of Prey"][1][12] = deep_copy(FamilySkills[12])
  spelldata["Bird of Prey"][1][13] = deep_copy(FamilySkills[13])
  spelldata["Carrion Bird"][1][2] = deep_copy(FamilySkills[2])
  spelldata["Carrion Bird"][1][3] = deep_copy(FamilySkills[3])
  spelldata["Carrion Bird"][1][12] = deep_copy(FamilySkills[12])
  spelldata["Carrion Bird"][1][13] = deep_copy(FamilySkills[13])
  spelldata["Wind Serpent"][1][2] = deep_copy(FamilySkills[2])
  spelldata["Wind Serpent"][1][12] = deep_copy(FamilySkills[12])
  spelldata["Wind Serpent"][1][19] = deep_copy(FamilySkills[19])
  ...
  for class, data in pairs(spelldata) do
    if type(data) == "table" then
      table.sort(spelldata[class][1], indexSort)
      if table.maxn(spelldata[class][1]) ~= #spelldata[class][1] then
        for i = 1, table.maxn(spelldata[class][1]) do
          if not spelldata[class][1][i] then
            spelldata[class][1][i] = "null"
          end
        end
        for i = #spelldata[class][1], 1, -1 do
          if spelldata[class][1][i] == "null" then
            table.remove(spelldata[class][1], i)
          end
        end
      end
    end
